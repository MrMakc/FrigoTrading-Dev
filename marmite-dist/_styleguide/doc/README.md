...
_For long/advanced code or if you want to see the real source code before changing by JS action prefer the php include method, it will be easier to maintain the code._

__includes/styleguide\_exemples/my\_include.php__
```
<h1 class="title1">My H1 element snippet</h1>
<h2 class="title2">My H2 element snippet</h2>
```
...
<div class="xrayhtml">
    <div class="snippet">
        <?php include 'includes/path/my_include.php' ?>
    </div>
    <div class="source-panel">
        <pre>
            <code class="language-markup">
<?php echo_include('includes/path/my_include.php'); ?>
            </code>
        </pre>
    </div>
</div>
...
_For long/advanced code or if you want to see the real source code before changing by JS action prefer the twig include method, it will be easier to maintain the code._

__includes/my/include.html.twig__
```
<h1 class="title1">My H1 element snippet</h1>
<h2 class="title2">My H2 element snippet</h2>
```
...
<div class="xrayhtml">
    <div class="snippet">
{% block sgMyBlocExemple %}
{% include "C2isOneTeaBundle:includes:my/include.html.twig" %}
{% endblock sgMyBlocExemple %}
    </div>
    <div class="source-panel">
        <pre>
            <code class="language-markup">
{{ block('sgMyBlocExemple')|replace({'<': '&lt;'})|raw }}
            </code>
        </pre>
    </div>
</div>
